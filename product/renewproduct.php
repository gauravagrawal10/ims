...
<div class="container">
    <div class="col-lg-12 mt-4">
        <div class="d-flex align-items-center">
            <h1 class="text-warning text-center"> RENEW STOCKS </h1>
            <a href="/ims/product/addproduct.php" class="ml-auto btn btn-primary" style="height:fit-content;">Add product</a>
        </div>
        <br>
        <table id="myproduct" class="table table-info table-hover ">
            <thead>
            ...
            <tbody>
                ...
                $q = "select * from products WHERE `quantity` < `min_quantity`";
